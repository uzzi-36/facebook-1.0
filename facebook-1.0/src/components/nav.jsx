 import { FaBell, FaSearch, FaFacebook, FaHome, FaUserFriends, FaStore, FaFacebookMessenger } from "react-icons/fa";
import { MdOutlinePersonalVideo } from "react-icons/md";
import { TbGridDots } from "react-icons/tb";
import { BsFillMoonFill, BsSun } from "react-icons/bs";

// FaChessBoard
function Header({ toggleThemeMode, s }) {
        ...
        <div className="header">
            ...
            <div className="hsb-4 ">
                ...
                <div type="" className="dp">
                    <img src="./imgs/dp.jpg" alt="DP" width={20} />
                </div>
